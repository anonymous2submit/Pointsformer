"""
Based on Model10, change configures for ABCDE, configures are exactly same to model2.
...
def model11A(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes, embed_dim=64,
                   pre_blocks=[1, 1, 1, 1], pos_blocks=[1, 1, 1, 1], k_neighbors=[32, 32, 32, 32],
                   reducers=[2, 2, 2, 2], **kwargs)

def model11B(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes, embed_dim=32,
                   pre_blocks=[1, 1, 1], pos_blocks=[1, 1, 1], k_neighbors=[32, 32, 32],
                   reducers=[2, 2, 2], **kwargs)

def model11C(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[1,1,1,1], pos_blocks=[1,1,1,1], k_neighbors=[32,32,32,32],
                 reducers=[2,2,2,2], **kwargs)

def model11D(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2,2], pos_blocks=[2,2,2,2], k_neighbors=[32,32,32,32],
                 reducers=[2,2,2,2], **kwargs)

def model11E(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)

def model11F(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes,embed_dim=64,
                 pre_blocks=[3,3], pos_blocks=[2,2], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model11G(num_classes=40, **kwargs) -> Model11:
    return Model11(points=1024, class_num=num_classes, embed_dim=64,
