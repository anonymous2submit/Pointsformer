...
def model19A(num_classes=40, **kwargs) -> Model19:  # 20695MiB
    return Model19(points=1024, class_num=num_classes, embed_dim=64,
                  pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                  reducers=[2, 2, 2], **kwargs)


def model19B(num_classes=40, **kwargs) -> Model19:  # 10817MiB
    return Model19(points=1024, class_num=num_classes, embed_dim=64,
                  pre_blocks=[2, 2, 2], pos_blocks=[2, 2, 2], k_neighbors=[32, 32, 32],
                  reducers=[4, 2, 2], **kwargs)


def model19C(num_classes=40, **kwargs) -> Model19:  # 25261MiB
    return Model19(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[4,4,4], k_neighbors=[32,32,32],
                 reducers=[2,2,2], **kwargs)


def model19D(num_classes=40, **kwargs) -> Model19:  # 32305MiB
    return Model19(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[48,48,48],
                 reducers=[2,2,2], **kwargs)


def model19E(num_classes=40, **kwargs) -> Model19:
    return Model19(points=1024, class_num=num_classes, embed_dim=64,
...
def model19Lite_A(num_classes=40, **kwargs) -> Model19:  # 7335MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=64,
                 pre_blocks=[2,2], pos_blocks=[2,2], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model19Lite_B(num_classes=40, **kwargs) -> Model19:  # 6003MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=32,
                 pre_blocks=[2,2], pos_blocks=[2,2], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)


def model19Lite_C(num_classes=40, **kwargs) -> Model19:  # 7875MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=64,
                 pre_blocks=[3,3], pos_blocks=[3,3], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model19Lite_D(num_classes=40, **kwargs) -> Model19:  # 9767MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=64,
                 pre_blocks=[3,3,3], pos_blocks=[3,3,3], k_neighbors=[32,32,16],
                 reducers=[4,4,2], **kwargs)

def model19Lite_E(num_classes=40, **kwargs) -> Model19:  # 6537MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=32,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model19Lite_F(num_classes=40, **kwargs) -> Model19:  # 4969MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=32,
                 pre_blocks=[2,3,2], pos_blocks=[2,3,2], k_neighbors=[32,16,8],
                 reducers=[4,4,4], **kwargs)


def model19Lite_G(num_classes=40, **kwargs) -> Model19:  # 7831MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=48,
                 pre_blocks=[2,3,2], pos_blocks=[2,3,2], k_neighbors=[32,16,8],
                 reducers=[4,4,4], **kwargs)


def model19Lite_H(num_classes=40, **kwargs) -> Model19:  # 5745MiB
    return Model19(points=1024, class_num=num_classes,embed_dim=64,
