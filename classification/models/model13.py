"""
Based on Model12, only last block is used, hence no concat
...
def model13A(num_classes=40, **kwargs) -> Model13:
    return Model13(points=1024, class_num=num_classes, embed_dim=512,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 heads=4, dim_head=32, reducers=[4,4,2], **kwargs)
