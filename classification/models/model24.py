"""
Exactly equals to Model21/23 (the best results so far), but add heads, dim_head into configurations.
...
def model24A(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=8, dim_head=32,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model24B(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=6, dim_head=32,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model24C(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=1, dim_head=128,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model24D(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=4, dim_head=64,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model24E(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=8, dim_head=64,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model24F(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=8, dim_head=128,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model24G(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=4, dim_head=128,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)
...
def model24H(num_classes=40, **kwargs) -> Model24:
    return Model24(points=1024, class_num=num_classes, embed_dim=128, heads=4, dim_head=32,
                 pre_blocks=[4,4], pos_blocks=[4,4], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)
