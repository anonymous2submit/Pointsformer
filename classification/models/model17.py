"""
Based on Model10, try add token in local region.
...
class Model17(nn.Module):
    def __init__(self, points=1024, class_num=40, embed_dim=64,
        ...
        self.token_list = nn.ParameterList()
        ...
        for i in range(len(pre_blocks)):
            ...
            # append token
            self.token_list.append(nn.Parameter(torch.rand([1,1,1,out_channel])))
    ...
    def forward(self, x):
        ...
        for i in range(self.stages):
            ...
            b,g,k,d = x.shape
            token = self.token_list[i].expand([b,g,1,d])
...
def model17A(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def model17B(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[2,2,2], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def model17C(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[32,32,32],
                 reducers=[4,2,2], **kwargs)

def model17D(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=32,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[4,2,2], **kwargs)

def model17E(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[20,20,20],
                 reducers=[4,2,2], **kwargs)

def model17F(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4,4], pos_blocks=[2,2,2], k_neighbors=[16,16,16],
                 reducers=[4,2,2], **kwargs)

def model17G(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=64,
                 pre_blocks=[4,4], pos_blocks=[2,2], k_neighbors=[32,32],
                 reducers=[4,4], **kwargs)

def model17H(num_classes=40, **kwargs) -> Model17:
    return Model17(points=1024, class_num=num_classes, embed_dim=64,
